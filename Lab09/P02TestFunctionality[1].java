...
public class P02TestFunctionality {
	...
	private static final String UNDERFLOW = "Stack underflow.  Not enough operands on stack.";
	/** The return value when the answer is infinity. */
	private static final String INFINITY = "Infinity";
	/** The return value when values are left on the stack. */
	private static final String OVERFULL_STACK = "Computed answer, but values remain on stack.";
	...
	private void runTest(String input, Double expected) {
		try {
			String result = PostfixEvaluator.evaluate(input);
			try {
