 ...
 *   - Open and closing parenthesis (two separate categories).
 *   
...
public class Token {
	...
	/** The precedence of this token in an expression; 1 for multiplication and division otherwise 0. */
	 ...
	 * @postcondition The type, value, and precedence are set to make this token be whatever was in
	 *   the string.
	 */
